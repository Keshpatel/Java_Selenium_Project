...
//				By.cssSelector("input.form-control.private-form__control.login-email");
				...
				//text():
		//htmltag[text()='']
//		//h2[text()='Summer Toy List']

//		//h2[text()='Deals in Electronics']
...
// 				input[id='username'] -- CSS
		...
		//td[text()='Venisha More']//parent::td//preceding-sibling::td//child::input
		//a[text()='JA Haynes']//parent::td//following-sibling::td
