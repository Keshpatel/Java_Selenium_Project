...
public class DropDownOptions {
	...
	public static void main(String[] args) {
		...
		System.out.println(getDopDownOptionsCount(country));
		System.out.println(getDopDownOptionsCount(industry));
		
		List<String> industryOptions = getDopDownOptionsValue(industry);
...
//			}
	...
	public static int getDopDownOptionsCount(By locator) {
		Select select = new Select(getElement(locator));
		List<WebElement> optionsList = select.getOptions();
		return optionsList.size();
	}
	public static List<String> getDopDownOptionsValue(By locator) {
